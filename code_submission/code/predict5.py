...
def Predict_fifth():
	...
	for i in range(len(all_data)):
		if "严重骨质疏松" in all_data["3601"][i]:
		    temp.append(3)
		elif "重度骨量减少" in all_data["3601"][i]:
		    temp.append(3)
		elif "中度骨量减少" in all_data["3601"][i]:
		    temp.append(2)
	...
	all_data.drop(["1102","0116","0119","0201","0202","0731","0732","300131","3731","3813","0409","0434","0439",
		           ...
		           "0501","0503","0509","0516","0537","0539","0541","0703","0705","0706","0707","0709","3730",
		           "0901","0947","0949","0954","0972","0975","0977","0978","0979","0980","0985","1001","1316",
		           "1103","1301","1302","1303","1304","1305","1313","1314","1315","3399","A201","A202",
		           "0212","0430","0432","0433","0976","0422","0427","1329","2501","979027","0986","1104","0929",
		           "A601","0225","0414","0415","0428","0440","0546","0981","0982","0983","0213","0974","0973",
