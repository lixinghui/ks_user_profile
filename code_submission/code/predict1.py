...
def Predict_first():
	...
	all_data["0431"]=all_data["0431"].replace({"无":"正常","无 无":"正常","无压痛点":"正常","未见异常 未见异常":"正常",np.nan:"正常"})

	all_data["0976"]=all_data["0976"].replace({"无":"正常","无 无":"正常",np.nan:"正常"})
	all_data["3400"]=all_data["3400"].map({"透明":"透明","浑浊":"浑浊","混浊":"浑浊","微混":"浑浊"})
	all_data["3400"].fillna("透明",inplace=True)
	all_data["0215"]=all_data["0215"].map({np.nan:"正常","正常":"正常"})
	all_data["0215"]=all_data["0215"].fillna("异常")
	all_data["0216"]=all_data["0216"].map({np.nan:"正常","正常":"正常","正常 正常":"正常","未见异常 未见异常":"正常"})
	all_data["0216"]=all_data["0216"].fillna("异常")
	all_data["0217"]=all_data["0217"].map({np.nan:"正常","正常":"正常","正常 正常":"正常","未见异常 未见异常":"正常"})
	all_data["0217"]=all_data["0217"].fillna("异常")
	all_data["0405"]=all_data["0405"].map({np.nan:"正常","未闻及":"正常","正常":"正常","无":"正常","未见异常 未见异常":"正常"})
	all_data["0405"]=all_data["0405"].fillna("异常")
	all_data["0406"]=all_data["0406"].map({np.nan:"正常","未触及 未触及":"正常","正常":"正常","未及":"正常",
		                                   "未见异常 未见异常":"正常"})
	all_data["0406"]=all_data["0406"].fillna("异常")
	all_data["0407"]=all_data["0407"].map({np.nan:"正常","未触及 未触及":"正常","未及":"正常","正常":"正常",
		                                   "未见异常 未见异常":"正常","未触及":"正常","不大":"正常",})
	all_data["0407"]=all_data["0407"].fillna("异常")
	all_data["0420"]=all_data["0420"].map({np.nan:"正常","未闻及异常":"正常","正常 正常":"正常","正常":"正常",
		                                   "未见异常 未见异常":"正常","有力":"正常",})
	...
	all_data.drop(["1102","0116","0119","0201","0202","0731","0732","300131","3731","3813","0409","0434","0439",
		           "0203","0206","0207","0208","0209","0222","0403","0413","0429","0715","0726","0728","0929",
		           "0501","0503","0509","0516","0537","0539","0541","0703","0705","0706","0707","0709","0423",
		           "0901","0947","0949","0954","0972","0975","0977","0978","0979","0980","0985","1001",
		           "1103","1301","1302","1303","1304","1305","1313","1314","1315","3399","A201","A202","1330",
		           "0212","0430","0432","0433","0976","0422","0427","1329","2501","979027","0986","1104",
		           "A601","0225","0414","0415","0428","0440","0546","0981","0982","0983","0213","0974",
	...
	all_data.drop(["0101","0102"],axis=1,inplace=True)  ###0101检查项目0102中都有，因此drop
